    ...
    <div class="fixed z-10 w-[15rem] h-16 -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-6 left-1/2">
        <div class="grid h-full max-w-lg grid-cols-3 mx-auto">
            ...
            <div class="flex items-center justify-center">
                <button on:click={()=>goto("/home/vehicle-type")} data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-blue-800 rounded-full hover:bg-blue-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
